    ...
    <div class="container-fluid">
        ...
        <div class="card mb-3">
            <div class="card-header">
                <i class="fas fa-chart-area"></i> <span id="cardTitle"> Add Slider</span>
                <div>
                    <?php
            ...
            <div class="card-body">
                <div class=" col-md-12">
                    <form id="formGallery" method="post" action="<?php echo base_url() ?>save_slider" enctype="multipart/form-data">
                        ...
                        <!-- <div class="form-group row">
                            ...
                            <div class="col-md-9">
                                <textarea name="slogan" id="description" class="form-control" autocomplete="off"></textarea>
        ...
        <div class="table-responsive">
            <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                ...
                <?php
                if(isset($getSliderData)):
                    $i = 1;
                    foreach($getSliderData as $slider):
                        ?>
                        <tr>
                    <td><?php echo $i++; ?></td>
                    ...
                    <td>
                        <a href="<?php echo base_url() ?>edit_slider/<?php echo $slider->id ?>" class="btn btn-warning" d >edit<i class="fa fa-pencil-square-o" aria-hidden="true"></i></a>

                            <a onclick="return confirm('Are you sure to delete this data ? ')"
                               href="<?php echo base_url() ?>delete_slider/<?php echo $slider->id ?>"  title="Delete This"  class="btn btn-danger ">delete<i class="fa fa-trash-o" aria-hidden="true"></i></a>
