<div id="content-wrapper">
    <div class="container-fluid">
        ...
        <div class="card mb-3">
            ...
            <div class="card-body">
                <div class=" col-md-12">
                    <form id="formGallery" method="post" action="<?php echo base_url() ?>save_commonpart" enctype="multipart/form-data">

                        <div class="form-group row">
                            <label class="col-md-2 col-form-label">Title <span class="red">*</span></label>
                            <div class="col-md-9">
                                <input type="text" name="com_title" id="title" class="form-control" placeholder="Title" autocomplete="off" value="<?php echo set_value('title') ?>">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-9">
                                <textarea name="com_description" id="description" class="form-control" autocomplete="off"></textarea>
                        ...
                        <!-- <div class="form-group row">
                            ...
                            <div class="col-md-9">
                                <input type="text" name="com_type" id="title" class="form-control" placeholder="Type" autocomplete="off" value="<?php echo set_value('title') ?>">
        ...
        <div class="table-responsive">
            <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                ...
                if(isset($Allcommonpart)):
                    ...
                    <td>
                        <a href="<?php echo base_url() ?>edit_news/<?php echo $common->com_id ?>" class="btn btn-warning" d >edit<i class="fa fa-pencil-square-o" aria-hidden="true"></i></a>

                            <a onclick="return confirm('Are you sure to delete this data ? ')"
                               href="<?php echo base_url() ?>delete_commonpart/<?php echo $common->com_id ?>"  title="Delete This"  class="btn btn-danger ">delete<i class="fa fa-trash-o" aria-hidden="true"></i></a>
