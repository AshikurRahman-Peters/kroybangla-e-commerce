    ...
    <div class="container-fluid">
        ...
        <div class="card mb-3">
            <div class="card-header">
                <i class="fas fa-chart-area"></i> <span id="cardTitle"> Add Image</span>
                <div>
                    <?php
            ...
            <div class="card-body">
                <div class=" col-md-12">
                    ...
                    <form id="formGallery" method="post" action="<?php echo base_url() ?>save_image" enctype="multipart/form-data">
                        <div class="form-group row">
                            <label class="col-md-2 col-form-label">Image <span class="red">*</span></label>
                            <div class="col-md-9">
                                <input type="file" name="image" id="title" placeholder="image" autocomplete="off">
        ...
        <div class="table-responsive">
            <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                ...
                <tr>
                    <td><?php echo $i++; ?></td>
                    <td>
                        <img style="width: 50px;" src="<?php echo base_url() ?>uploads/images/<?php echo $image['image'] ?>" alt="">

                    </td>
                    <td>
                        <a href="<?php echo base_url() ?>edit_image/<?php echo $image['id'] ?>" class="btn btn-warning" d >edit<i class="fa fa-pencil-square-o" aria-hidden="true"></i></a>

                            <a onclick="return confirm('Are you sure to delete this data ? ')"
                               href="<?php echo base_url() ?>delete_image/<?php echo $image['id'] ?>"  title="Delete This"  class="btn btn-danger ">delete<i class="fa fa-trash-o" aria-hidden="true"></i></a>
